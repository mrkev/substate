...
export function notify(
  ...
  // utility to allow structs to hear when they (or any child) change
  if ("_changed" in subbable && typeof subbable._changed === "function") {
    subbable._changed(target, subbable);
  }
}
